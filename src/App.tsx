...
const toggleTheme = () => {
  ...
  return (
    <>
    <ThemeToggle />
    <div className="bg-white text-black dark:bg-[#0B1120] dark:text-white transition-colors duration-300"></div>
          <WelcomeAudio />
          <Sparkle 
        color="violet" 
        count={40} 
      ...
      <header className="fixed top-0 w-full z-50 bg-[#0B1120]/90 backdrop-blur-md shadow-md">
        <nav className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          {/* Logo */}
          <a href="#hero" className="text-xl font-bold text-violet-400 hover:text-violet-300 transition-colors">
            Hire Me!
          </a>
          {/* Nav Links */}
      ...
      <div className="bg-white text-black dark:bg-[#0B1120] dark:text-white">
              <motion.div
      ...
      <div id="hero" className="h-screen bg-gradient-to-br from-[#0B1120] to-[#0F172A] flex flex-col justify-center items-center px-4 text-center">
            <header className="space-y-6 max-w-3xl">
              ...
              <p className="inline-flex items-center justify-center gap-2 text-purple-400 bg-slate-800 px-4 py-1 rounded-full text-lg font-medium w-fit mx-auto border border-purple-500">
                <Sparkles className="w-4 h-4 text-purple-400" />
                Senior Software Engineer
              </p>
              <div className="flex justify-center flex-wrap gap-4 mt-6 text-violet-500">
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-violet-500 to-indigo-500 rounded-lg hover:from-violet-600 hover:to-indigo-600 transition-all duration-300 shadow-md"
                >
                  ...
                  <section id="education" className="h-screen flex flex-col justify-center items-center px-6 bg-[#0F172A]">
                  ...
                  <section id="experience" className="h-screen flex flex-col justify-center items-center space-y-6 px-6 bg-[#0F172A]">
            ...
            <section id="skills" className="h-screen flex flex-col justify-center items-center space-y-6 px-6 bg-[#0B1120]">
                  ...
                  <section id="blogs" className="h-screen flex flex-col justify-center items-center space-y-6 px-6 bg-[#0F172A]">
                    <h2 className="text-2xl font-semibold text-sky-400">Blogs (Upcoming)</h2>
                    <p className="text-slate-400 italic">Coming soon...</p>
                  </section>

                  <section id="contact" className="h-screen flex justify-center items-center px-4 bg-gradient-to-br from-[#0B1120] to-[#0F172A]">
                  ...
                  <button
                    onClick={toggleTheme}
                    className="fixed bottom-4 left-4 z-50 bg-violet-500 text-white dark:bg-yellow-300 dark:text-black px-4 py-2 rounded-full shadow-md transition-colors"
                  >
